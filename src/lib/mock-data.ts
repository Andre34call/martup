...
export const MOCK_PRODUCTS: Product[] = [
  {
    ...
    price: 21999000, stock: 50, sold: 1200, minOrder: 1, weight: 221, condition: 'new', productType: 'product' as const, status: 'active',
  ...
  },
  {
    ...
    price: 19999000, discountPrice: 17999000, stock: 35, sold: 890, minOrder: 1, weight: 232, condition: 'new', productType: 'product' as const, status: 'active',
  ...
  },
  {
    ...
    price: 189000, discountPrice: 149000, stock: 200, sold: 3500, minOrder: 1, weight: 250, condition: 'new', productType: 'product' as const, status: 'active',
  ...
  },
  {
    ...
    price: 459000, discountPrice: 359000, stock: 80, sold: 1200, minOrder: 1, weight: 300, condition: 'new', productType: 'product' as const, status: 'active',
  ...
  },
  {
    ...
    price: 1299000, discountPrice: 999000, stock: 30, sold: 850, minOrder: 1, weight: 800, condition: 'new', productType: 'product' as const, status: 'active',
  ...
  },
  {
    ...
    price: 27999000, discountPrice: 25999000, stock: 20, sold: 450, minOrder: 1, weight: 1550, condition: 'new', productType: 'product' as const, status: 'active',
  ...
  },
  {
    ...
    price: 75000, discountPrice: 55000, stock: 500, sold: 8900, minOrder: 1, weight: 30, condition: 'new', productType: 'product' as const, status: 'active',
  ...
  },
  {
    ...
    price: 189000, discountPrice: 149000, stock: 120, sold: 2300, minOrder: 1, weight: 450, condition: 'new', productType: 'product' as const, status: 'active',
  ...
  },
  {
    ...
    price: 250000, discountPrice: 189000, stock: 200, sold: 1800, minOrder: 1, weight: 1200, condition: 'new', productType: 'product' as const, status: 'active',
  ...
  },
  {
    ...
    price: 3299000, discountPrice: 2899000, stock: 40, sold: 620, minOrder: 1, weight: 6500, condition: 'new', productType: 'product' as const, status: 'active',
  ...
  },
  {
    ...
    price: 6499000, discountPrice: 5799000, stock: 25, sold: 380, minOrder: 1, weight: 3200, condition: 'new', productType: 'product' as const, status: 'active',
  ...
  },
  {
    ...
    price: 350000, discountPrice: 245000, stock: 300, sold: 5600, minOrder: 1, weight: 500, condition: 'new', productType: 'product' as const, status: 'active',
