...
const CheckoutScreen = lazy(() => import('@/components/ecommerce/checkout').then(m => ({ default: m.CheckoutScreen })))
const OrderScreen = lazy(() => import('@/components/ecommerce/order').then(m => ({ default: m.OrderScreen })))
